...
def cross_validate_penalty_parameter(x, y, title, create_model_func, hyperparameters):
    ...
    mean_error=[]
    standard_deviations=[]
    hyperparameters = [0.001, 0.1, 1, 10, 100, 1000]
...
if __name__ == '__main__':
    parameter_list = ['film_total_likes', 'film_total_views', 'film_total_ratings', 'film_age', 'film_franchise', 'film_avg_rating', 'user_film_watched', \
              'film_rate_ratio', 'film_like_ratio', 'director_avg']
